      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 z-10 w-full">
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 w-full max-w-[440px] p-8 md:p-10 flex flex-col">
          <div className="text-center mb-8 flex flex-col items-center">
            ...
            <h1 className="text-[28px] font-bold text-slate-900 tracking-tight mt-4">Hey there, welcome back</h1>
          </div>

          <button className="w-full bg-[#0A66C2] hover:bg-[#004182] text-white font-bold py-3.5 px-4 flex items-center justify-center gap-2 rounded-lg transition-colors mb-6 shadow-sm cursor-pointer">
